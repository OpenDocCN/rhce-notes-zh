# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P79：中级运维-16.事务，锁，备份-上 - 小方脸不方- - BV138411B7p5
...
再用一些delete update update update去更改啊，那如果说修改命令比较多，不太好改的情况下，你可以直接回滚，这个roll back就是回滚的意思，相当于直接什么直接回滚，快到了。

相当于直接回本快照了啊，正常提交提交之后呢啊你可以理解成什么，提交之后我们做完这一个事务之后呢，相当于又拍了一个新的快照啊，又拍了个新快照，那之前的快照就可以了，之前快照就相当于删掉了啊。
...
因为什么呢，因为读这个操作呢，它不会对我们数据进行很大的一个修改啊，不会对我们数据进行到大造成影响，所以说我们这个毒所呢它就是一个共享的数啊，共享所什么意思，就是可以有多个多个事物同时来运行啊。
