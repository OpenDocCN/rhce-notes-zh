# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P39：红帽RHCE-3.编写脚本、脚本执行方式 - 小方脸不方- - BV138411B7p5
...
这没有任何问题，它是一个固定的格式，它它的主要的功能就是给你干嘛呢，就是给你来一个这个就是给你增加个这个东西，能理解吧，对我说叫装逼利器，好那这就是脚本，虚拟的虚拟的哈。
