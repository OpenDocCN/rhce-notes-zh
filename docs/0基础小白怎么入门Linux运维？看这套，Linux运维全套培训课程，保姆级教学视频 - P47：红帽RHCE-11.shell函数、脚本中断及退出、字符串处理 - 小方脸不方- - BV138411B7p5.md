# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P47：红帽RHCE-11.shell函数、脚本中断及退出、字符串处理 - 小方脸不方- - BV138411B7p5
...
如果你想替换全部两根斜线回车，这样就可以了，就多加一根斜线，所以这样的话呢就要替换全部，这里面是多了一根斜线，好好这是替换掐头去尾，掐头去尾的话呢，这个我们一般也用，也几乎用不到。
