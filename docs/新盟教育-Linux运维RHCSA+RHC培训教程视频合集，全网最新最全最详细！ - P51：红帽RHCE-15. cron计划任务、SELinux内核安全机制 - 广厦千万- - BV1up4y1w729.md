# 新盟教育-Linux运维RHCSA+RHC培训教程视频合集，全网最新最全最详细！ - P51：红帽RHCE-15. cron计划任务、SELinux内核安全机制 - 广厦千万- - BV1up4y1w729
...
这是它的日志文件，你看一下文件里边，这个文件里边记录的是什么呢？就是如果说他帮你执行了某些操作的话，他会记录这个时间。比如说我们后期写一个计划任务，让他在凌晨3点帮我们去执行一个操作。那他会给你记录。
