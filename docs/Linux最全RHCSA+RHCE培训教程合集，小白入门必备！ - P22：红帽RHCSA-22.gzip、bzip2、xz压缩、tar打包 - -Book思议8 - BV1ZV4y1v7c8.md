# Linux最全RHCSA+RHCE培训教程合集，小白入门必备！ - P22：红帽RHCSA-22.gzip、bzip2、xz压缩、tar打包 - -Book思议8 - BV1ZV4y1v7c8
...
没有压缩之前哈，是656K放到这，咱们就拿这个文件来做对比哈，那压缩完了之后呢，首先这个文件啊就直接变成一个压缩格式了，那现在我们来看它的大小，我们度杠H统计一下，哎哟你们看一下哈。
