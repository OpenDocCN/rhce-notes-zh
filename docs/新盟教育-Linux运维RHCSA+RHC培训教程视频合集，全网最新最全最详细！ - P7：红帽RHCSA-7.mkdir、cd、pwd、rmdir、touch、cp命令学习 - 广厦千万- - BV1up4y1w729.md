# 新盟教育-Linux运维RHCSA+RHC培训教程视频合集，全网最新最全最详细！ - P7：红帽RHCSA-7.mkdir、cd、pwd、rmdir、touch、cp命令学习 - 广厦千万- - BV1up4y1w729
...
好，那接啊接下来呢我们再来说说这个PWD这条命令。那对于PWD这条命令啊，它是干嘛用的呢？它是这个。
