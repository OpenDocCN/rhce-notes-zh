# 【小白入门 通俗易懂】全网最全RHCSA+RHCE教程，一周快速进阶Linux运维 - P52：红帽RHCE-16.常见协议及端口介绍、firewalld防火墙 - 网工小程立志不加班 - BV1PN4y1R7uU
...
即便打开了也是乱码乱码，这个乱码就像你看什么呢，你看一个那个二进制文件一样，比如说我看一个CB一下的一个二进制文件。
