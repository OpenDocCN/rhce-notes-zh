# 【小白入门 通俗易懂】全网最全RHCSA+RHCE教程，一周快速进阶Linux运维 - P13：红帽RHCSA-13.修改网卡地址、host、nslookup命令、alias命令别名、history管理命令历史、date日期时间管理 - 网工小程立志不加班 - BV1PN4y1R7uU
...
这个文件里面就是存放我们一个命令别名的，你看还有一个点，你看到了吧，这个L点知道这点是什么意思吗，你看他这LS杠D点星，首先呢是有一个杠D选项，杠D是不是看目录本身呢，没错吧，点星代表什么，点星代表。
