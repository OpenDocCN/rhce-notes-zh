# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P28：红帽RHCSA-28.逻辑卷扩容、RAID磁盘阵列 - 小方脸不方- - BV138411B7p5
...
在右边这个read1里面还有一个一模一样的文件，不是但它的特点是什么，就是这里边到这儿来就是25%了，25%哈，啊等会我看一下，我这我应该怎么怎么给你们解释这个东西哈，我觉得25%他不是很对哈。
