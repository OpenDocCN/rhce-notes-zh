# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P51：红帽RHCE-15. cron计划任务、SELinux内核安全机制 - 小方脸不方- - BV138411B7p5
...
写一个备份脚本行吧，我们先去编写一个备份脚本，这个应该比较简单吧，备份的脚本啊，备份脚本的话我们放在哪呢，MADR真下script，进来之后，我们我们先说说BF脚本对杠XF对Y下的，让它叫什么呢。
