# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P8：红帽RHCSA-8.mv、cat、less、head、tail、rm命令学习 - 小方脸不方- - BV138411B7p5
...
在这个目录下的所有都被你给删掉了，所以这个星号代表任意所有是什么都行，我都能够表示他，所以呢对于这个删除的操作呢，如果你想删文件，你不需要加杠R就想删文件哈，你看我们前面在这个media。
