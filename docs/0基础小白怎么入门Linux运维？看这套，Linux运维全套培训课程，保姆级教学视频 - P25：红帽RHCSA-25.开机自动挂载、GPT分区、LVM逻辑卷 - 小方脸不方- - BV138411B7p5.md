# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P25：红帽RHCSA-25.开机自动挂载、GPT分区、LVM逻辑卷 - 小方脸不方- - BV138411B7p5
...
我要不要对这个数据做一个再做一个备份啊，但是这个备份你想做也行，但是我们一般不会在这个里面去，做一些什么备份，因为在企业里面你想备份的话，我们一般会自己单独去，比如说我是在企业里边。
