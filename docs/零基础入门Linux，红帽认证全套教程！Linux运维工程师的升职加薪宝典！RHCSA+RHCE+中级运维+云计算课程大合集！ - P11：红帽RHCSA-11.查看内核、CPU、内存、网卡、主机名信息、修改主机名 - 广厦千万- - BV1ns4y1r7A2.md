# 零基础入门Linux，红帽认证全套教程！Linux运维工程师的升职加薪宝典！RHCSA+RHCE+中级运维+云计算课程大合集！ - P11：红帽RHCSA-11.查看内核、CPU、内存、网卡、主机名信息、修改主机名 - 广厦千万- - BV1ns4y1r7A2
...
没错吧，所以没事，你会发现大家会去看什么东西呢？哎，会从这个任务管理器里面会看我的内存信息。😊。
