# 01 RHCE8.0视频教程【45课时】 - P29：20200419-RHCE-02_recv - 六竹书生6682 - BV1m84y1f7ss
...
因为我刚才那边的话呢，空格忘忘记去空了，空格忘记去空了，Cat s06，对不对，这个的话呢我们是用if else的形式的话呢，来写的这个问题。
...
case它只适合这种叫做离散的情况，我们来看叫做差距，S07点SH，全剧mod a加XS07EIMS07，井号打3号下面的special，然后的话呢是一样的，第一个read减P，比如说请问，亚美元是否。
...
对不对，我们来看一下，这边点S，我应该是哪里写错了，叫做let哦，这里我前后加了空格，有问题了，第二个空格，你看123456789吧，98，那这边的话呢，首先第一个我们去定义一个变量。
...
第一个信息的话呢，可能是root12345677个星期对吧，那比如说我读取的时候呢，我只是想要用户名和你的这个序号，可以怎么办，可以怎么办，这边的话呢我们就要这样子，while对的。

比如说cl1第一个还有呢去读，第二个去读，第三个是不是就够了，第四个我们都可以不用去读了，不ECOACH解密，因为中间的话呢，可能就是说第一列在输出的时候，和第三列在输出的时候呢。

中间希望有一个风格不慢，开火键去分格骂啊，接下去dollar coo l3，然后呢这里down一下，稍等，这里你看这里刚才的话呢是读整行整行的信息，比如说我们现在想要去读列的信息。

你看一下这里得到的信息是怎么样子的，诶他还是整行读取出来，没有把一个一个信息读取出来啊，为什么会这样子呢，这是和我们的分割符有关系的，我们来看一下默认情况下，它的一个分割符是什么东西，上班后的。

这也没有去写，这边的话呢我们默认的分割符它是一个符，就是说是一个分号线的话呢，比如说我们想要去设置一个新的分隔符啊，不IFS，他的话呢默认IFS，然后呢现在ifs的话呢，分割符我这边是冒号对吧。
...
这样子我到时候去打印第三列的时候呢，就不会去携带后面的所有信息了，能明白吗，就这样子，这里的话呢我给你们来看一下，pc pass word中，获取获取什么呢，叫做用户名和UID名字命名的话呢。
...
他这里的话呢一开始的时候呢，它的分割符是应该是一个分号，现在的话呢就是说我们把它恢复一下，Ifs，他的话呢就OIIFS就等于这个嘛，因为我刚才的话呢是进行了一次保留吗，应该就是一个IFS。
...
它和前面两个就不太一样了，前面的for也好，while也好，是不是满足条件就去执行啊，他呢条件不满足，才去执行，条件不满足他才执行它的格式，是这样子的，NTR了解，然后呢。

然后呢down中间的话呢就是我们执行的命令了，我们来看一下，如果说现在的话呢，我们想要去打印1~10的话，可以怎么样啊，touch a哦不对，S十二十二SH全剧mod a加XS12好吧，V i m。

首先第一个，我比如说和刚才的一个while是一样的，declare减IAA等于一，好吧，until这边条件怎么写，我们等一下再来写什么呢，是不是以扣取solar aa呀。

这边肯定有一个和AA相关的变化的函数吧，那我们说了只有条件不满足的时候才来执行，那也就是说高了AA有没有大于十吗，下A等于一的时候，他没有大于十吧，那就来执行，知道吗，然后AA如果大于十的时候呢。

它就不执行了对吧，那这个AA的话呢是不是还要去递增的呀，本身就应该是递增的吗，大家看一下，一开始的时候A等于一小于等于大于等于十吗，没有，所以就等于一，那现在A的话，那等于二。

A等于二的时候有没有大于等于十呢，没有，那这个二就输出了，等于三呢，等于四等于五，等于六，等于七，等于八等于九，九的时候有没有大于等于十，大于大于十呢，没有九就显示嘛。

那好现在等于十的时候有没有大于十呢，没有十就显示再加一，是不是11啊，11有没有大于十呢，有那我这个循环就结束了就结束了，11就打印不出来，就打印到十过，能听明白吗。

他这个的话呢和其他的东西来说是特殊很多的。
