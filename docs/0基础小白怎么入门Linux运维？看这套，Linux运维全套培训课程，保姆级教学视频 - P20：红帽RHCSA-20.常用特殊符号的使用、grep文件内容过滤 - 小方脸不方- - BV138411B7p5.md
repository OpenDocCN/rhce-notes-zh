# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P20：红帽RHCSA-20.常用特殊符号的使用、grep文件内容过滤 - 小方脸不方- - BV138411B7p5
...
说非常好用的，唉非常好用哈，我们以后会频繁用GRP这条命令啊，这这条命令也可以怎么玩的呢，这条命令你可以这样，比如说我这样if config，这条命令不是看网卡吗，是不是是不是看网卡好，没关系。
