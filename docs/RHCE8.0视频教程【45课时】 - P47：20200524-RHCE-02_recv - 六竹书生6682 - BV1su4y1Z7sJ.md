# RHCE8.0视频教程【45课时】 - P47：20200524-RHCE-02_recv - 六竹书生6682 - BV1su4y1Z7sJ
...
就这样去写吧，在这里就是说首先这里第一个hosters，你的话呢要给谁去使用，比如说我们还是给这个web 2012，去进行一个使用，然后接下去远端的一个操作主机的话呢，是呃操作用户的话呢是谁。
