# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P30：红帽RHCSA-29.程序、进程、线程介绍、查看进程树 - 小方脸不方- - BV138411B7p5
...
名字都一样，能理解吧，所以这个我们说命令也行，说进程也行，在这个里边哈，就你看后边啊，然后我们再往上翻上去，还没说完呢，哈对吧，再继续说这TTY都清楚了吧，然后这个TTY的话呢是如果是远程终端。
