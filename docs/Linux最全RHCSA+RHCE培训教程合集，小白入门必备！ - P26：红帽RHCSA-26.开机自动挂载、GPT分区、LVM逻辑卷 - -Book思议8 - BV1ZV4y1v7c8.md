# Linux最全RHCSA+RHCE培训教程合集，小白入门必备！ - P26：红帽RHCSA-26.开机自动挂载、GPT分区、LVM逻辑卷 - -Book思议8 - BV1ZV4y1v7c8
...
这个PV这个概念呢，是因为在渗透S7里面，47这个系统里边的时候，我们是不需要去手动自己创建这个PV的啊，不需要去自己去创建这个物理卷的，为什么呢，因为系统会自动帮我们创建，所以这条命令大家不用记。
