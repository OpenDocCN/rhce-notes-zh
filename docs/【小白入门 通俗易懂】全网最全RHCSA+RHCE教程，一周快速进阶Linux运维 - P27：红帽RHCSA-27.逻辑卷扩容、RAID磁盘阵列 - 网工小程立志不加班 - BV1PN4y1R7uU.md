# 【小白入门 通俗易懂】全网最全RHCSA+RHCE教程，一周快速进阶Linux运维 - P27：红帽RHCSA-27.逻辑卷扩容、RAID磁盘阵列 - 网工小程立志不加班 - BV1PN4y1R7uU
...
不想用的话，你得先删除你的这个逻辑卷，DF杠H看你得先把这个螺旋给它删掉，但删的时候呢，你得先卸u mt，把这个关键点给它卸掉，web vet目录，而开机自动挂载也给它卸掉，这个哈删掉dd啊。
