# Linux网络运维架构／RHCE红帽认证／云计算／第3章-文件系统的管理方法和xfs文件系统备份恢复 - P1：3.1-Linux系统目录结构和相对路径与绝对路径 - 乔治学院 - BV1ra4y1L7Bq
...
啊，看看这里面的标志位，关于虚拟化那个模块有没有打开。所以后期我们查看一些系统，查看一些进程信息的时候，会在这里面用。那具体用到的时候，我们具体去了解好不好？
