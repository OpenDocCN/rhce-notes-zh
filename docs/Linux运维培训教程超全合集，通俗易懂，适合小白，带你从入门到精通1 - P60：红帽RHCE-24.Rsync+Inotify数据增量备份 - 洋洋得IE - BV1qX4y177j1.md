# Linux运维培训教程超全合集，通俗易懂，适合小白，带你从入门到精通1 - P60：红帽RHCE-24.Rsync+Inotify数据增量备份 - 洋洋得IE - BV1qX4y177j1
...
好安装好了吧，安装好了之后，我们是不是进到那个安装路径啊，Use a local innotify，好那接下来对于这个目录呢，看他的bin就行了，这个bin目录就是他的命令，这个命令呢你直接干嘛呀。
