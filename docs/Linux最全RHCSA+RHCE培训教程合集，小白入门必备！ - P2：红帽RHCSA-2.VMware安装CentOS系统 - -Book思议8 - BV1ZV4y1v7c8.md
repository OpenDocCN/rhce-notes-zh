# Linux最全RHCSA+RHCE培训教程合集，小白入门必备！ - P2：红帽RHCSA-2.VMware安装CentOS系统 - -Book思议8 - BV1ZV4y1v7c8
...
给这个虚拟机一个G内存了，还有就是这个虚拟如果你一关机的话，那它是不会消耗你的内存的，只有开机的时候才会消耗内存，如果一关机的内存呢，啊这个还是在你的真机上边能理解吧，啊所以这个没有关系哈。
