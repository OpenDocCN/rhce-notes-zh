# Linux最全RHCSA+RHCE培训教程合集，小白入门必备！ - P37：红帽RHCE-1.shell脚本概念介绍、脚本编写规范 - -Book思议8 - BV1ZV4y1v7c8
...
所以这个很多为为什么说搞编程的搞编程的呀，这个呵呵呵呵呵呵呵行了，高一是吧对，所以说为什么说这搞编程的人，他这个哈哈哈，搞编程的人，他这个一般容易掉头发呢，他确实你不安慰一下，他确实容易掉头发哈。
...
你自己这样去看吧，这就是UNIX风格，而BH的风格呢啊我们退出哈，X的退出，回到BH的风格，BH的风格你就敲个LS，它有颜色，最起码我一看就知道这是个目录了是吧，这白色是个文件，这是个压缩包，是不是。

所以说这个你们现在能够感受到，etc的shells，你们现在能够感受到这个解释器了吗，就是我们当前登录系统的这个命令，命令提示符就是有解释器提供的好，你一登录好，我给你分配这个解释器。

那你敲的所有命令都有这个解释器去负责解释，解释给谁听呢，解释给内核定区分大小写，区分大小写啊，这个系统本身就是严格区分大小写，那就像小写的L和大写的I，它就是不是同一个东西啊。

严格区分大小写哈啊你比如说我这样，我用这个batch帮我解释一个什么呢，S的命令嗯，无法执行啊，sorry哈，这不行，没有这样玩的哈，没有这样玩的，对这些都是解释器，你看SH的解释器跟BH解释器。
...
这所谓的脚本，这是不是本质是个命令的堆积啊，注意啊，你们看一下它的本质是命令的堆积，没错吧。
