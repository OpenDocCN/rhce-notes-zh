# 新盟教育-Linux运维RHCSA+RHC培训教程视频合集，全网最新最全最详细！ - P35：红帽RHCSA-34.软件版本升级、网络YUM仓库配置、设置YUM仓库优先级 - 广厦千万- - BV1up4y1w729
...
能列吧？这翻翻译软件上，翻译软件就它就它啊网易有道哈，网易有道哈。但是这个网易有道这个翻译你得配一配配什么呢？😊，它这里面是这样子的，就是它有个叫华瓷华瓷哈，这华瓷你得勾选上在这个里边。有个滑磁的功能。
