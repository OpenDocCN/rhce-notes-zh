# Linux运维培训教程超全合集，通俗易懂，适合小白，带你从入门到精通1 - P2：红帽RHCSA-2.VMware安装CentOS系统 - 洋洋得IE - BV1qX4y177j1
...
显示器看到了吗，这不就是虚拟他干的事儿吗，啊但是没有什么鼠标键盘哈，这里边儿，好接下来我们就得选择一下啊，我们对这一堆硬件，你比如说内存啊，你希望这个虚拟机的内存空间是多大的内存呢，哎这个就蛮重要了。

你看那虚拟机呢啊就是我们改啊，就是你的对于这个虚拟机注意事项啊，注意事项，呃我们在这个什么呢，在学习的环境和学习环境，我们是通过虚拟机去安装操作系统的，安装LINUX的系统。
...
那对8G内存，那我们在创建虚拟机的时候，你看我电脑总共8G内存，我电脑一运行是吧，我起了所有的软件，那都是吃我这八个G内存的，那这八个G内存的话，比如我这个虚拟机我分配两个G内存好。
