# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P93：DevOps-3.GitLab快速入门 - 小方脸不方- - BV138411B7p5
...
好。啊，这是他的一个介绍，他说构建伟大无所不能。这个子是一个开源的CID软件领导者。提供超过1000个插件来支持构建部署自动化，来满足你的任何的项目需求。然后下面呢也是对他做了一个介绍。
