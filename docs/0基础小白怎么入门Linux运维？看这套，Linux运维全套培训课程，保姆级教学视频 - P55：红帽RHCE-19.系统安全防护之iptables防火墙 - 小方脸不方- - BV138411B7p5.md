# 0基础小白怎么入门Linux运维？看这套，Linux运维全套培训课程，保姆级教学视频 - P55：红帽RHCE-19.系统安全防护之iptables防火墙 - 小方脸不方- - BV138411B7p5
...
Ip tables，然后，啊sorry哈，Service，IPTFC5好了，规则保存到哪里了呢，保存到这个路径下的这个文件里面去了，所以以后你想改规则，打开这个路径下的这个文件。
